...
class _TransactionDetailPageState extends State<TransactionDetailPage> {
  ...
  try {
    final uploadResponse = await context
  ...
  void _showUploadConfirmation() {
    ...
    : Image.network(
        ...
        fit: BoxFit.cover,
            ...
            Text(
              'Upload this image as payment proof?',
              style: AppTheme.bodyStyle,
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          _buildInfoRow(
                                            ...
                                            DateFormat(
                                              'dd MMM yyyy, HH:mm',
                                            ).format(_transaction!.orderDate),
                                          ),
                                          _buildInfoRow(
                                            'Expired Date',
                                            DateFormat(
                                              'dd MMM yyyy, HH:mm',
                                            ).format(_transaction!.expiredDate),
                                          ),
                                          _buildInfoRow(
                                            'Payment Method',
                                    ...
                                    // Action Buttons
                                    if (_transaction!.status.toLowerCase() ==
                                        'pending')
                                      Column(
                                        children: [
                                          SizedBox(
