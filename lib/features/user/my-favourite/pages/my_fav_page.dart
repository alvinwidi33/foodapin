...
class _MyFavPageState extends State<MyFavPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<MyFavBloc>().add(const FetchFavFoods());
    });
  }
  ...
  void _onScroll() {
    ...
    final state = context.read<MyFavBloc>().state;

    if (_isBottom && state is MyFavLoaded) {
      context.read<MyFavBloc>();
    }
  }
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                Text("My Favourite", style: AppTheme.headingStyle),
                const SizedBox(height: 24),
                
                Expanded(
                  child: BlocBuilder<MyFavBloc, MyFavState>(
